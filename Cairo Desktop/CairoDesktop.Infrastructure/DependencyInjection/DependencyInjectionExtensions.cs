...
public static class DependencyInjectionExtensions
{
    ...
    public static IServiceCollection AddDependencyLoadingServices(this IServiceCollection services,
        IConfiguration configuration, string path, string pattern = null)
    {
    ...
    public static IServiceCollection AddDependencyLoadingServices(this IServiceCollection services,
        IConfiguration configuration, string[] paths, string pattern = null)
    {
    ...
    public static ILoggingBuilder AddManagedShellLogging(this ILoggingBuilder builder,
        Action<ManagedShellFileLoggerOptions> configure = null)
    {
