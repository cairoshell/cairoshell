...
public partial class Volume : UserControl
{
    ...
    private void InitializeVolumeIcon()
    {
        ...
        DispatcherTimer volumeIconTimer = new DispatcherTimer(new TimeSpan(0, 0, 0, 2), DispatcherPriority.Background,
            delegate { VolumeIcon_Tick(); }, Dispatcher);
    }
    ...
    {
        ShellHelper.StartProcess("sndvol.exe",
            "-f " + (int)(((ushort)(System.Windows.Forms.Cursor.Position.X / DpiHelper.DpiScaleAdjustment)) |
                          (uint)((int)ActualHeight << 16)));
    }
    ...
    {
        ShellHelper.StartProcess("sndvol.exe",
            "-T " + (int)(((ushort)(System.Windows.Forms.Cursor.Position.X / DpiHelper.DpiScaleAdjustment)) |
                          (uint)((int)ActualHeight << 16)));
    }
}