...
{
    public static DependencyProperty ParentContainerProperty = DependencyProperty.Register("ParentContainer",
        typeof(StacksContainer), typeof(StacksScroller), new PropertyMetadata(null));
    ...
    private void Open_Click(object sender, RoutedEventArgs e)
    {
        ...
        ParentContainer?.OpenDir((sender as ICommandSource).CommandParameter.ToString(),
            KeyboardUtilities.IsKeyDown(System.Windows.Forms.Keys.ShiftKey));
    }
    ...
    private bool InvokeContextMenu(ShellFile file, bool isInteractive)
    {
        ...
        var _ = new ShellItemContextMenu(new ShellItem[] { file }, DataContext as ShellFolder, IntPtr.Zero,
