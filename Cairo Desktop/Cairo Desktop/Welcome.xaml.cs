...
public partial class Welcome : Window
{
    ...
    private void cboLangSelect_DropDownClosed(object sender, EventArgs e)
    {
        ...
        {
            CairoMessage.Show(DisplayString.sWelcome_ChangingLanguageText, DisplayString.sWelcome_ChangingLanguage,
                MessageBoxButton.OK, CairoMessageImage.Information,
                result =>
                {
                    if (result == true)
                    {
