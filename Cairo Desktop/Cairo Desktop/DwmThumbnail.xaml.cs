...
public partial class DwmThumbnail : UserControl
{
    ...
    {
        get { return _sourceWindowHandle; }
        set
        {
            ...
            if (_sourceWindowHandle != IntPtr.Zero && Handle != IntPtr.Zero &&
                NativeMethods.DwmRegisterThumbnail(Handle, _sourceWindowHandle, out _thumbHandle) == 0)
                Refresh();
        }
    }
