...
public partial class CairoApplication : System.Windows.Application, ICairoApplication
{
    ...
    private void Application_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        try
        {
            if (!_errorVisible)
            {
                ...
                {
                    if (MessageBox.Show(dMsg, "Cairo Desktop Error", MessageBoxButton.YesNo, MessageBoxImage.Warning) ==
    ...
    public static string CairoApplicationDataFolder =>
