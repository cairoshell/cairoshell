...
public class Category : IList<ApplicationInfo>, INotifyPropertyChanged, INotifyCollectionChanged
{
            ...
            if (PropertyChanged != null)
            {
                ...
                PropertyChanged(this,
                    new PropertyChangedEventArgs(
                        "DisplayName")); // because DisplayName returns Name if not a special category type
            }
        }
    }
    ...
    public void RemoveAt(int index)
    {
        ...
        {
            CollectionChanged(this,
                new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, app, index));
        }
    ...
    public ApplicationInfo this[int index]
    {
        ...
        set
        {
            ...
            {
                CollectionChanged(this,
                    new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace, value, oldApp));
            }
        }
    }
    ...
    public bool Remove(ApplicationInfo item)
    {
        ...
        try
        {
            ...
            {
                CollectionChanged(this,
                    new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, info, index));
            }
