...
public class CategoryList : ObservableCollection<Category>
{
    ...
    private void Category_CollectionChanged(object sender,
        ...
        foreach (XmlElement catElement in root.ChildNodes)
        {
            ...
            foreach (XmlElement appElement in catElement.ChildNodes)
            {
                ...
                else
                {
                    ...
                    {
                        ManagedShell.UWPInterop.StoreApp storeApp =
                            ManagedShell.UWPInterop.StoreAppHelper.AppList.GetAppByAumid(app.Target);
