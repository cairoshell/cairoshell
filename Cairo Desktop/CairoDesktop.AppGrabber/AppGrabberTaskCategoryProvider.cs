...
public class AppGrabberTaskCategoryProvider : ITaskCategoryProvider
{
    ...
    private void CategoryList_CollectionChanged(object sender,
    ...
    {
        return window.IsUWP ? GetCategoryDisplayNameOfUWPApp(window) : GetCategoryDisplayNameOfWin32App(window);
    }
