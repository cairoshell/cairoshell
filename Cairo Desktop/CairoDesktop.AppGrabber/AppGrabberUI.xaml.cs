...
public partial class AppGrabberUI : Window
{
    ...
    public static readonly DependencyProperty AppVisibilityProperty = DependencyProperty.Register("AppVisibility",
        typeof(Visibility), typeof(AppGrabberUI), new PropertyMetadata(null));

    private static readonly DependencyProperty bAppsHiddenProperty =
        DependencyProperty.Register("bAppsHidden", typeof(bool), typeof(AppGrabberUI), new PropertyMetadata(null));
    ...
    private void btnBrowse_Click(object sender, RoutedEventArgs e)
    {
               ...
               })
        {
            if (dlg.SafeShowDialog() == System.Windows.Forms.DialogResult.OK && ShellHelper.Exists(dlg.FileName))
            {
                ...
                {
                    if (!programsMenuAppsCollection.Contains(customApp) &&
                        !(InstalledAppsView.ItemsSource as ObservableCollection<ApplicationInfo>).Contains(customApp))
                    {
    ...
    void programsMenuAppsCollection_CollectionChanged(object sender,
    ...
    private void Window_ContentRendered(object sender, EventArgs e)
    {
        ...
        programsMenuAppsCollection.CollectionChanged +=
            new System.Collections.Specialized.NotifyCollectionChangedEventHandler(
                programsMenuAppsCollection_CollectionChanged);
        ...
        foreach (ApplicationInfo app in apps)
        {
            ...
            {
                if (autoAddApps && ((app.IsStoreApp && autoSelectByName(app.Name)) ||
                                    (!app.IsStoreApp && autoSelectByName(Path.GetFileNameWithoutExtension(app.Path)))))
