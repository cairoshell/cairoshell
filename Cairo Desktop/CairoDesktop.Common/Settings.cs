...
public class Settings : INotifyPropertyChanged, IMigratableSettings
{
    ...
    private static string _settingsPath =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Cairo Desktop",
            "settings.json");
    ...
    public bool MigrationPerformed
    {
        get => _migrationPerformed;
    }
    ...
    private string[] _pinnedNotifyIcons =
    {
        NotificationArea.HEALTH_GUID, NotificationArea.POWER_GUID, NotificationArea.NETWORK_GUID,
