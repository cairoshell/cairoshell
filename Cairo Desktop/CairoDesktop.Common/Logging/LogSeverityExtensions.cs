...
{
    private static readonly Dictionary<ManagedShell.Common.Logging.LogSeverity, LogLevel>
        ManagedShellLogSeverityToLogLevelDictionary = new Dictionary<ManagedShell.Common.Logging.LogSeverity, LogLevel>
        {
    ...
    private static readonly Dictionary<LogSeverity, LogLevel> CairoShellLogSeverityToLogLevelDictionary =
    ...
    private static readonly Dictionary<LogLevel, ManagedShell.Common.Logging.LogSeverity>
        LogLevelToManagedShellLogSeverityDictionary = new Dictionary<LogLevel, ManagedShell.Common.Logging.LogSeverity>
        {
    ...
    private static readonly Dictionary<LogSeverity, ManagedShell.Common.Logging.LogSeverity>
        CairoShellLogSeverityToManagedShellLogSeverityDictionary =
            new Dictionary<LogSeverity, ManagedShell.Common.Logging.LogSeverity>
            {
