...
namespace CairoDesktop.Common.ViewModels
{
    class MonitorPreferenceViewModel : INotifyPropertyChanged
    {
        ...
        public AppBarScreen UseScreen
        {
            get
            {
                return _preference is MonitorFromCoordinatesPreference preference
        ...
        public MonitorPreferenceViewModel()
        {
            ...
            Screens = new ReadOnlyObservableCollection<ScreenViewModel>(new ObservableCollection<ScreenViewModel>(screens));
