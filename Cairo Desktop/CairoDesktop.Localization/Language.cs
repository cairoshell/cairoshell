...
namespace CairoDesktop.Localization
{
    static class Language
    {
        ...
        public static Dictionary<string, string> fr_FR = new Dictionary<string, string>
        {
            ...
            { "sAbout_Copyright", "Copyright © 2007-{0} Cairo Development Team and community contributors.  Tous droits réservés." },
            { "sInterface_OK", "OK" },
            ...
            { "sAppGrabber_Page2Directions4", "Clic droit sur une catégorie to pour la renommer." },
            ...
            { "sMenuBar_ToggleNotificationArea", "Afficher/masquer les icônes de la zone de notifications" },
            ...
            { "sSettings_General_ForceSoftwareRendering", "Forcer le rendu logiciel (advancé)" },
            ...
            { "sSettings_Taskbar_EnableTaskbar", "Activer la barre de tâches" },
            { "sSettings_Taskbar_TaskbarPosition", "Position de la barre de tâches :" },
            { "sSettings_Taskbar_PositionBottom", "Bas" },
            { "sSettings_Taskbar_PositionTop", "Haut" },
            { "sSettings_Taskbar_DisplayMode", "Mode d'affichage :" },
            { "sSettings_Taskbar_DisplayModeAppBar", "La barre de tâches réserve l'espace" },
            { "sSettings_Taskbar_DisplayModeOverlap", "La barre de tâches chevauche les fenêtres" }
        };
    }
}
