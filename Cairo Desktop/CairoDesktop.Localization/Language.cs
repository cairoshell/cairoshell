...
namespace CairoDesktop.Localization
{
    static class Language
    {
        public static Dictionary<string, string> en_US = new Dictionary<string, string>
        {
            ...
            { "sSettings_MenuBar_EnableCairoMenuHotKey", "Enable Cairo menu hotkey (press Win + Shift + Z)" },
            ...
            { "sSettings_Desktop_EnableDesktopOverlay", "Enable desktop overlay (press Win + Shift + D)" },
