...
Section "$(SECT_cairo)" cairo
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CairoShell" "Publisher" "Proshell Network"
...
SectionEnd
  ...
  LangString PAGE_Finish_RunText ${LANG_ENGLISH} "Start Proshell Catalyst Environment"
